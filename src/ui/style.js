...
export const inject = async () => {
  const style_menu_css_path = new URL('../css/menu.css', import.meta.url).href
  const style_menu = document.createElement("link")
  style_menu.rel = "stylesheet"
  style_menu.type = "text/css"
